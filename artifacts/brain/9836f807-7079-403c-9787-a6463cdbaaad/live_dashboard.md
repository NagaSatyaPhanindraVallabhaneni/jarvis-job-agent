# Jarvis Autonomous Job Agent — Live Control Center
...
| **Indexed Companies** | **520 US Companies** | Automatically harvested from live search & registry |
...
| **Candidate** | `Naga Satya Phanindra Vallabhaneni` | MS Computer Science (Univ of Dayton) &bull; `+1 984-687-6001` |
| **Competition Gate** | **<= 50 Applicants** | Applied via career page only if LinkedIn competition is low |
...
| **LLM Engine** | `inclusionai/ling-3.0-flash-vl:free` | **Strict $0.00 spend architecture** (Free Router) |
